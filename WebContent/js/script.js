function crearGrafo(data) {
	var links = [ {
		source : "http://opendata.euskadi.eus/UDA",
		target : "UDA",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/UDA",
		type : "http://opendata.euskadi.eus/certification"
	}, {
		source : "http://opendata.euskadi.eus/ISTQB",
		target : "ISTQB",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/ISTQB",
		type : "http://opendata.euskadi.eus/certification"
	}, {
		source : "http://opendata.euskadi.eus/TrabajoEntidadesPrivadas",
		target : "Trabajo en proyectos de entidades privadas",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/TrabajoEntidadesPrivadas",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/TrabajoEntidadesPublicas",
		target : "Trabajo en proyectos de entidades publicas",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/TrabajoEntidadesPublicas",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/TrabajoDesarrolloGeneral",
		target : "Trabajo en proyectos desarrollo general",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/TrabajoDesarrolloGeneral",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/TrabajoProyectoID",
		target : "Trabajo en proyectos I+D",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/TrabajoProyectoID",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/java",
		target : "Java",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/java",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/html",
		target : "HTML",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/html",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/c++",
		target : "C++",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/c++",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/PMP",
		target : "PMP",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/PMP",
		type : "http://opendata.euskadi.eus/certification"
	}, {
		source : "http://opendata.euskadi.eus/r",
		target : "R",
		type : "http://schema.org/name"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "http://opendata.euskadi.eus/r",
		type : "http://opendata.euskadi.eus/skill"
	}, {
		source : "http://opendata.euskadi.eus/Analyst",
		target : "Analista",
	...
	var circle = svg.append("svg:g").selectAll("circle").data(d3.values(resources))
			.enter().append("svg:circle").attr("class", function(d) {
				if(d.name.includes("http")){return "literal";}
				else{return "recurso";}
			})
			.attr({
				"r" : 15,
	...
	function arcPath(leftHand, d) {
		var start = leftHand ? d.source : d.target, end = leftHand ? d.target
				: d.source, dx = end.x - start.x, dy = end.y - start.y, dr = Math
				.sqrt(dx * dx + dy * dy), sweep = leftHand ? 0 : 1;
