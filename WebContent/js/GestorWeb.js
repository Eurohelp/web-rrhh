...
function obtenerDatosRecurso(pRecurso, boolean) {
 ...
 $.ajax({
  ...
  success: function(data) {
   $("#search").css("visibility", "visible");
   console.log("Que movidaaaaaaaaaaaaaaaa");
   $("svg").remove();
   if (data.includes("vacio")) {
    $("svg").remove();
...
function validar(clase) {
 ...
 if (boolCat == true && ckboxHabilidades.length == 0 && ckboxCertificaciones.length == 0 && ckboxIdioma.length == 0 && ckboxExperiencia.length == 0 && ckboxUniversidad.length == 0) {
  ...
  // una certificacion o una habilidad
   ...
   eliminarOpcionesMenu(1); console.log(putada);
   putada=putada+1;
   obtenerJson(true);
  } else { console.log(putada);
  putada=putada+1;
   alertify
    .notify(
  ...
  // y aun no se ha generado aun menu para las demas
	 ...
	 console.log(putada);
	  putada=putada+1;if (clase != "Certificaciones" && clase != "Habilidades") {
   eliminarOpcionesMenu(1); console.log(putada);
   putada=putada+1;
   obtenerJson(true);
  } else { console.log(putada);
  ...
  // experiencia
	 ...
	 console.log(putada);
	  putada=putada+1;if (clase != "Idioma" && clase != "Experiencia" && clase != "Universidad") { console.log(putada);
	  putada=putada+1;
   if (clase == "Categoria") { console.log(putada);
   putada=putada+1;
  ...
  putada=putada+1;
   alertify
    .notify(
	 ...
	 console.log(putada);
	  putada=putada+1;if (clase != "Idioma" && clase != "Experiencia" && clase != "Universidad") {
   if (clase == "Categoria") { console.log(putada);
   putada=putada+1;
    eliminarOpcionesMenu(1);
   }
 ...
 // si no esta seleccionada la categoria y si otra opcion
	 ...
	 console.log(putada);
	  putada=putada+1; eliminarOpcionesMenu(1);
  eliminarOpcionesMenu(2);
 ...
 // pero alguna de las anteriores no
	 ...
	 console.log(putada);
	  putada=putada+1; if (boolCat == false) {
   eliminarOpcionesMenu(1);
  }
  eliminarOpcionesMenu(2);
  alertify
